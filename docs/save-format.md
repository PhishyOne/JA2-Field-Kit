...
admitted synthetic vector because the cataloged real save is not currently an
eligible test fixture. The parser does not identify a save family or select an
encryption scheme.
